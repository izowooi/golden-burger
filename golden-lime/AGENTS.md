...
> ## ⚠ 2026-07-28: 폐쇄 확정 권고 (백테스트로 가설 기각됨)
>
> **먼저 읽을 것: [최종 판정 — 사후 백테스트](../docs/retro/golden-lime-2026-07-backtest-verdict.md)**
> market_snapshots 103만 행으로 28개 파라미터 조합을 검정한 결과 거래비용을 넘는
> 표류가 없었다. 승률 41.2%가 무편향 이론값 40.0%와 일치하고, 시뮬레이션이 실제
> 계좌 손실을 98% 정확도로 예측한다. **손실의 정체는 파라미터가 아니라 거래비용이다.**
>
