...
class TradeRepository:
    ...
    def cleanup_old_snapshots(self, days: float = 7) -> int:
        ...
        Returns:
            삭제된 스냅샷 수
        """
        if compact_maintenance_active(self.session, "golden-elderberry"):
            return 0
    ...
    def append_trade_to_csv(self, trade: Trade, db_dir) -> None:
        ...
        row = {
            ...
            "ref_price_at_buy": trade.ref_price_at_buy or "",
            "drop_at_buy": trade.drop_at_buy or "",
