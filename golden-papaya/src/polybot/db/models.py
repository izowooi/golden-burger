"""SQLite evidence models for Golden Papaya / Final Five."""
...
class Trade(Base):
    """One submitted Final Five position and its observed evidence."""
...
class MarketSnapshot(Base):
    """Final Five research observation, always expressed as a YES price."""
