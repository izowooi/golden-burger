...
금액 증액, 꼬리손실 비대칭, 동시 20포지션의 정확한 의미와 `$100` 전환 전 실행 gate는
[증액·꼬리손실 가이드](docs/SCALING_AND_TAIL_RISK.md)에 고정한다. Gamma liquidity/volume
문턱만 올린 것을 주문장 depth 검증이나 증액 승인으로 해석하지 않는다.
