# Queue Echo preregistration — frozen 2026-08-13

이 문서는 첫 outcome을 보기 전에 고정한 `queue-echo-v1` 계약이다.
...
- experiment window: `[2026-08-13T01:00:00Z, 2026-09-12T01:00:00Z)`
...
100%; runtime p95 <180s/max <240s;
single valid lineage per confirmatory range; hidden failed-run sweep 0; quick_check okay;
