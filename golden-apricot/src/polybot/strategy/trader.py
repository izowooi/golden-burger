"""Order execution and evidence-safe settlement for Golden Apricot."""
...
class Trader:
    """Trade only bot-owned direct result tokens under the Apricot contract."""
    ...
    def execute_buy(self, candidate: dict) -> Optional[int]:
        ...
        logger.info(
            "Golden Apricot FOK BUY: '%s' result=%s side=%s adaptive_vwap=%.2f%% "
