"""Golden Apricot live trading-cycle orchestration."""
...
class PolymarketBot:
    ...
    def __init__(
        ...
        *,
        ...
        logger.info(
            ...
            "sport=%s direct_yes_no=%s source=%s preregistration=%s",
            config.job_name,
            config.simulation_mode,
    ...
    def _log_strategy_config(self) -> None:
        ...
        logger.info(
            "Golden Apricot %s baseline-$5 %s leader VWAP [%.3f, %.3f], "
        ...
        exit_contract = (
            ...
            else "tick50 full-holding bid VWAP 0.99, otherwise resolution"
            if entry.exit_basis == "tp99_or_resolution"
            else
    ...
    def run(self) -> None:
        ...
        audit = RunAudit.start(self.config, strategy_name="golden-apricot")
        try:
    ...
    def get_status(self) -> dict:
        ...
        try:
            ...
            isolated_stop_sells = repo.get_isolated_stop_sell_trades()
            return {
                "strategy": "Golden Apricot In-Play Match Result",
