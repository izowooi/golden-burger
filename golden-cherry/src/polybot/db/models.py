...
class TradeStatus(enum.Enum):
    ...
    QUARANTINED = "quarantined"      # 잔고 0이나 과거 order 증거가 소실된 격리 포지션
...
class Trade(Base):
    ...
    # Entry/Exit reasons (resolution momentum strategy)
    entry_reason = Column(String, nullable=True)   # "time_based", "manual"
    exit_reason = Column(String, nullable=True)    # "take_profit", "stop_loss", "trailing_stop", "time_exit"
