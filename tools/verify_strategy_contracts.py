...
def _validate_inplay_match_winner_research_strategy(
    ...
    contracts = {
        ...
        "src/polybot/analyzer.py": (
            "watermelon-major-sports-analyzer-v4b",
            "watermelon-major-sports-cadence-pair-v4b",
    ...
    current_preregistration = _require_file(
        findings,
        strategy,
        directory / "research/frozen-2026-09-03-five-major-sports-v4b/PREREGISTRATION.md",
    )
    _require_tokens(
        findings,
        strategy,
        ...
        (
            "2026-09-03T12:00:00Z", "2026-10-03T12:00:00Z",
            "watermelon-white-1m-v4b", "watermelon-grey-5m-v4b",
            "Soccer", "MLB", "NBA", "NFL", "NHL",
            "World Series", "NBA Finals", "Super Bowl", "Stanley Cup Final",
            "displayed-book counterfactual", "HIGH",
        ),
    )
    _require_file(
        findings,
        strategy,
        directory / "research/frozen-2026-09-03-five-major-sports-v4b/MANIFEST.sha256",
    )
    _require_file(
        findings,
        strategy,
...
def _validate_watermelon_live_strategy(
    ...
    contracts = {
        ...
        "src/polybot/config.py": (
            ...
            '"soccer": SportPolicy(4, stop_price=0.65',
            "emergency stop_price must match the sport policy",
...
def _validate_peach_strategy(
    ...
    for relative_path in (
        ...
        "research/frozen-2026-09-03-mlb-live-ab-v4/PREREGISTRATION.md",
        "research/frozen-2026-09-03-mlb-live-ab-v4/MANIFEST.sha256",
    ):
        _require_file(findings, strategy, directory / relative_path)
...
def _validate_plum_strategy(
    ...
    contracts = {
        ...
        "src/polybot/strategy/scanner.py": (
            ...
            "leader_vwap_outside_entry_band",
            "current_price_outside_entry_band",
            "claim_entry_episode",
            "direct",
        ),
        "src/polybot/strategy/trader.py": (
            ...
            "fresh_leader_vwap_below_entry_minimum",
            "fresh_leader_vwap_above_entry_maximum",
