...
@pytest.mark.parametrize("values,match", [
    ({"POLYBOT_BUY_THRESHOLD": "0.97", "POLYBOT_SELL_THRESHOLD": "0.90"}, "buy_threshold"),
    ({"POLYBOT_MOMENTUM_SHORT_WINDOW": "72", "POLYBOT_MOMENTUM_LONG_WINDOW": "72"}, "short_window"),
])
...
def test_invalid_boolean_env_is_rejected(monkeypatch):
    monkeypatch.setenv("POLYBOT_MOMENTUM_ENABLED", "tru")
