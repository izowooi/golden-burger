...
class Trade(Base):
    ...
    short_momentum_at_buy = Column(Float, nullable=True)
    long_momentum_at_buy = Column(Float, nullable=True)

    # Momentum data at sell (for analysis)
    short_momentum_at_sell = Column(Float, nullable=True)
    long_momentum_at_sell = Column(Float, nullable=True)
