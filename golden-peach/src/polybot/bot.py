"""Golden Peach live trading-cycle orchestration."""
...
class PolymarketBot:
    ...
    def __init__(
        ...
        *,
        ...
        logger.info(
            "Golden Peach bot initialized - job=%s simulation=%s lifecycle=%s "
    ...
    def run(self) -> None:
        ...
        audit = RunAudit.start(self.config, strategy_name="golden-peach")
        try:
