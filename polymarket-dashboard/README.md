...
Supabase에 적재된 네 개 Jenkins 전략의 잔고와 기간 수익률을 비교하는 로컬 대시보드입니다. Next.js App Router의 서버 Route Handler가 Supabase를 조회하므로 비밀키가 브라우저 번들에 포함되지 않습니다.

## 제공 기능

- `GOLDEN-APPLE (1)`, `GOLDEN-BANANA`, `GOLDEN-CHERRY`, `GOLDEN-APPLE (2)` 개별 표시/숨김
