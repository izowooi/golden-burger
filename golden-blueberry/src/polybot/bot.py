"""Closing Surge trading-cycle orchestration."""
...
class PolymarketBot:
    ...
    def __init__(self, config: BotConfig):
        ...
        logger.info(
            "Closing Surge bot 초기화 - job=%s simulation=%s lifecycle=%s "
            "arm=%s source_cohort=%s git_commit=provenance_only yes_only=%s",
            config.job_name,
            config.simulation_mode,
    ...
    def run_cycle(self) -> dict:
        ...
        try:
            ...
            logger.info(
                ...
                stats["sold"],
                stats["resolved"],
                db_stats.get("entry_signal_decisions", 0),
            ...
            return {
                ...
                "holdings": [
                    {
                        ...
                        "surge_at_entry": trade.surge_at_entry,
                        "min_surge_at_entry": trade.min_surge_at_entry,
                        "buy_timestamp": (
                ...
                "config": {
                    ...
                    "entry": {
                        ...
                        "min_surge": trading.entry.min_surge,
                    },
                    "archive": {
