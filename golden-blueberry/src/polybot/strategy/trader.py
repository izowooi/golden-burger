"""Order execution and evidence-safe settlement handling for Closing Surge."""
...
class Trader:
    ...
    def execute_buy(self, candidate: dict) -> Optional[int]:
        ...
        if candidate.get("is_sports"):
            ...
            # Blueberry is intentionally falling back to endDate.
        ...
        trade = self.repo.create_trade(
            ...
            snapshot_gap_minutes_at_entry=candidate.get(
                "snapshot_gap_minutes"
            ),
            surge_at_entry=decision.surge,
            min_surge_at_entry=self.config.entry.min_surge,
    ...
    def _place_sell_with_balance_retry(
        ...
        *,
        ...
        Blueberry deliberately does not retry a smaller SELL after a balance
