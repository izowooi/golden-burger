...
def test_api_connection() -> bool:
    ...
    if all_passed:
        ...
        print()
        print("You can now run the conservative simulation cohort:")
        print("  uv run polybot run --simulate --job sim")
        print("Live trading still requires an explicit config change and approval.")
    else:
