...
| golden-elderberry | [golden-elderberry.md](golden-elderberry.md) · **파라미터 조정 보류** → [2026-08 파라미터 리뷰](golden-elderberry-2026-08-parameter-review.md) | Panic Fade, `polybot-cherry` job에서 운영 |
