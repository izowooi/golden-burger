"""SQLite evidence models for Golden Melon / Resolution Sprint."""
...
class Trade(Base):
    """One submitted Resolution Sprint position and its observed evidence."""
...
class MarketSnapshot(Base):
    """Resolution Sprint research observation, always expressed as a YES price."""
...
def init_database(
    ...
    prepare_database(db_path, "golden-melon", requirements=maintenance_requirements)
