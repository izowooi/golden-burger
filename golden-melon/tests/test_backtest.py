"""Deterministic, offline Melon research backtest contract."""
...
SPEC = importlib.util.spec_from_file_location("quince_backtest", SCRIPT)
...
def test_run_writes_hashed_csv_json_manifest_and_no_database(
    ...
    assert manifest["engine_version"] == "quince-offline-v1"
