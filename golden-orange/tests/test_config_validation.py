...
@pytest.mark.parametrize("values,match", [
    ({"POLYBOT_BASE_MAX": "0.4", "POLYBOT_YES_MAX": "0.3"}, "probability bounds"),
    ({"POLYBOT_BASE_WINDOW_DAYS": "1", "POLYBOT_BASE_EXCLUDE_RECENT_HOURS": "24"}, "base_exclude_recent_hours"),
])
...
def test_invalid_boolean_env_is_rejected(monkeypatch):
    monkeypatch.setenv("POLYBOT_HISTORY_BACKFILL", "tru")
