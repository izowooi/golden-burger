...
def is_valid_buy_candidate(
    ...
    This prevents buying into markets that have already reached
    the sell threshold (rapid jumps).

    Args:
        probability: Current probability
        buy_threshold: Minimum probability to buy (e.g., 0.80)
        sell_threshold: Maximum probability to buy (e.g., 0.90)
