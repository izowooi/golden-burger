...
def test_buy_threshold_must_be_below_sell_threshold(monkeypatch):
    monkeypatch.setenv("POLYBOT_BUY_THRESHOLD", "0.95")
    monkeypatch.setenv("POLYBOT_SELL_THRESHOLD", "0.90")
