"""Crown Momentum trading-cycle orchestration."""
...
class PolymarketBot:
    ...
    def _log_strategy_config(self) -> None:
        ...
        logger.info(
            "Crown Momentum 전략 - prior YES < %.2f -> current YES [%.2f, %.2f], "
    ...
    def run_cycle(self) -> dict:
        ...
        try:
            ...
            logger.info("=== Phase 0: Crown Momentum research archive ===")
    ...
    def run(self) -> None:
        ...
        audit = RunAudit.start(self.config, strategy_name="golden-quince")
        try:
