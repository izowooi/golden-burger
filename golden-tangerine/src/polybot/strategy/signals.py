"""Pure signal functions for the Sports Resolution Hold Live strategy."""
...
def evaluate_entry(
    ...
    """Evaluate one Sports Resolution Hold Live entry.
...
def evaluate_exit(current_price: Optional[float], stop_price: float) -> Optional[str]:
    ...
    Sports Resolution Hold Live intentionally has no take-profit, trailing stop, or
