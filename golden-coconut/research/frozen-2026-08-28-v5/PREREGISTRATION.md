# Golden Coconut v5 Production-Identity Lifecycle Preregistration

Freeze time: 2026-08-27T16:40:00Z. Runtime: `coconut-major-sports-lifecycle-5m-v5`.

The objective is prospective displayed-book research and collection health for
soccer, MLB, NBA, NFL, and NHL whole-game moneyline markets. V1 through v4 runtimes,
databases, and frozen files are immutable historical evidence and are never imported into v5.
...
invalid collection cohort. V5 freezes a semantic root-or-season event-series identity and exact
production draw descriptor without importing or editing v4 evidence.
